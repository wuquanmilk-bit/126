...
const PageLoader = () => (
  <div className="flex flex-col justify-center items-center p-20 text-gray-400 animate-pulse">
    ...
    <p className="font-medium text-sm">ai加载中...</p>
  </div>
);
        ...
        <div className="max-w-7xl mx-auto px-4 flex justify-between h-16 items-center">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex space-x-6">
              ...
              <Link to="/novels" className="hover:text-blue-600 font-bold transition-colors">学霸说</Link>
              <Link to="/videos" className="hover:text-blue-600 font-bold transition-colors">短视频</Link>
              <Link to="/questions" className="hover:text-blue-600 font-bold transition-colors">AI问答</Link>
            </div>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <Link to="/write/novel" className="flex items-center gap-1.5 px-3 py-2 bg-gray-900 text-white rounded-xl hover:bg-black transition-all active:scale-95 shadow-lg shadow-gray-200">
              ...
              <span className="hidden sm:inline text-xs font-black uppercase">写感悟</span>
            </Link>
