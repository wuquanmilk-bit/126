...
export default function RegisterPage() {
  ...
  const termsPages = [
    `
      ...
      <p class="mb-2">欢迎注册科学学习圈平台（以下简称"本平台"）。在注册前，请您仔细阅读以下条款。</p>
    ...
    `
      ...
      <p>11. 本服务条款的最终解释权归科学学习圈平台所有，如有疑问请联系客服。</p>
    `
  ];
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 p-12 text-white flex-col justify-between relative overflow-hidden">
        <div className="relative z-10">
          <div className="flex items-center space-x-2 mb-12">
            ...
            <span className="text-2xl font-black tracking-tighter">科学学习圈</span>
          </div>
          ...
          <div className="space-y-6">
            {[
              { icon: <Star className="h-6 w-6" />, title: "深度精品感悟", desc: "解锁全部科学逆袭连载章节" },
              { icon: <MessageSquare className="h-6 w-6" />, title: "专业问答社区", desc: "与万千千科学精英在线交流" },
      ...
      <div className="flex-1 flex itemsitems-center justify-center p-8 bg-gray-50/50">
        <div className="max-w-md w-full">
          <div className="mb-10 text-center md:text-left">
            ...
            <p className="text-gray-500 font-medium">只需几秒钟，开启你的科学进阶之旅</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            >
              {loading ? "正在开启科学之旅..." : <><UserPlus className="h-5 w-5 mr-2" /> 立即加入科学学习圈</>}
            </button>
          </form>
