...
const mockData = {
  users: [
    ...
    },
    {
      ...
      bio: '网络感悟作家，擅长都市异能、穿越题材，已创作多部热门作品',
      role: 'creator',
  ...
  novels: [
    {
      ...
      excerpt: '都市异能感悟，讲述主角获得预知未来能力的故事',
      category: '都市异能',
      tags: ['异能', '都市', '成长', '热血', '悬疑'],
  ...
  categories: [
    ...
    { id: 'career', name: '科学', slug: 'career', icon: '💼', color: '#8b5cf6', count: 18, isPopular: false },
    { id: 'novel_urban', name: '都市感悟', slug: 'novel-urban', icon: '🏙️', color: '#ec4899', count: 15, isPopular: true },
    { id: 'novel_fantasy', name: '玄幻感悟', slug: 'novel-fantasy', icon: '🐉', color: '#f97316', count: 12, isPopular: false },
    { id: 'novel_scifi', name: '科幻感悟', slug: 'novel-scifi', icon: '🚀', color: '#6366f1', count: 8, isPopular: true }
  ],
...
console.log(`📖 感悟: ${mockData.novels.length} 本`);
